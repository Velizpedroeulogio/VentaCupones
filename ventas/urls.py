...
urlpatterns = [
    ...
    path("<int:evn>/autoges/",            views.autoges_view,        name="autoges"),
    path("<int:evn>/autoges/flyer/",      views.autoges_flyer_view,  name="autoges_flyer"),
    ...
    path("<int:evn>/confirmar-efectivo/",     views.confirmar_efectivo_api,    name="confirmar_efectivo"),
    path("<int:evn>/pago-parcial/",           views.pago_parcial_view,         name="pago_parcial"),
    path("<int:evn>/pago-parcial/cancelar/",  views.cancelar_pago_parcial_api, name="cancelar_pago_parcial"),
